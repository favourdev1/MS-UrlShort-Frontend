<template>
  ...
  <aside
  :class="{
    'translate-x-0': isSidebarOpen && isMobile, // Apply the transform on mobile screens
 
    'translate-x-[-22rem]': !isSidebarOpen && isMobile // Hide sidebar or reset the transform on non-mobile screens
  }"
  class="fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform border-r"
